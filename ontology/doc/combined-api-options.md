...
In principle approach (1) could be extended so that a data query could optionally return a zipped file stream combining the requested data segments and a standardized capture of all the relevant metadata with a Data Package type wrapper.
