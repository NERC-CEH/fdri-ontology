...
COPY(
SELECT SITE_INSTRUMENTATION.SITE_ID,PARAMETERS_INSTRUMENTS.PARAMETER_ID,TIMESERIESDEF.TIMESERIES_ID,MIN(START_DATETIME) AS START_DATE,MAX(TIMESERIESDEF.PROCESSING_LEVEL) as PROCESSING_LEVEL,MAX(TIMESERIESDEF.DURATION) AS PERIOD
    ...
    GROUP BY SITE_INSTRUMENTATION.SITE_ID, PARAMETERS_INSTRUMENTS.PARAMETER_ID, TIMESERIESDEF.TIMESERIES_ID, START_DATETIME
